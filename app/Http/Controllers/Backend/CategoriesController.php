...
class CategoriesController extends backendController
{
    ...
    {
        $categories = Category::orderBy('title')->paginate(6);
    ...
    public function store(Requests\CategoryStoreRequest $request)
    {
        ...
        return redirect(route('categories.index'))->with('message','New category created successfully');
    }
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect(route('categories.index'))->with('message','Category was updated successfully');
    }
    ...
    public function destroy(Requests\CategoryDestroyRequest $request,$id)
    {
        ...
        return redirect(route('categories.index'))->with('message','Category was deleted successfully');
    }
}
